...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class PlanarReflections : MonoBehaviour
    {
        ...
        PlanarReflectionSettingData tmpData;
        private void ExecutePlanarReflections(ScriptableRenderContext context, Camera camera)
        {
            ...
            if (tmpData == null)
            {
                tmpData = new PlanarReflectionSettingData();
            }
            // save quality settings and lower them for the planar reflections
            tmpData.Set(); // set quality settings
            ...
            tmpData.Restore(); // restore the quality settings
