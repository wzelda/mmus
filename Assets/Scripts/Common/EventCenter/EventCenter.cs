...
/// <summary>
/// Eventer.Add(you register)
/// Eventer.Remove(you register)
/// lvchengyuan
/// </summary>
public class EventCenter
{
    ...
    public static bool ContainsListener(string eventType)
    {
        return m_eventController.ContainsEvent(eventType);
    }
