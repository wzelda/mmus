...
namespace FairyGUI
{
    ...
    public class StageCamera : MonoBehaviour
    {
        ...
        public static int srpRendererIndex = -1;
        ...
        public static void SetRendererIndex(int index)
        {
            srpRendererIndex = index;
        ...
        public static Camera CreateCamera(string name, int cullingMask)
        {
            ...
            // 自定义渲染器
            if (srpRendererIndex != -1)
            {
                data.SetRenderer(srpRendererIndex);
            }
