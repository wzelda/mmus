...
tutorial_process_ImproveReady =
{
	-- 对话
	[1] = {stepId=1,mask = true, eventBegin="", delayTime=0, eventEnd=Event.OPEN_FUNC, beginFuc="", endFunc="", 
		['tips'] = {
			[1] = {param01=nil, param02="", param03=nil, param04=nil, param05=10, tipType="story"}, 
		}
	},
	--页签点击
	[2] = {stepId=2,mask = false, eventBegin="", delayTime=0, eventEnd=Event.OPEN_FUNC, beginFuc="", endFunc="", 
		['tips'] = {
			[1] = {param01=UIKey.ImproveTabBtn, param02="", param03=nil, param04=nil, param05=nil, tipType="click"}, 
		}
	},
}