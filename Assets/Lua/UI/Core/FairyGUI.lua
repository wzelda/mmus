...
--防止和自定义的事件派发器冲突
local EventDispatcher = CS.FairyGUI.EventDispatcher
...
FUIConfig = CS.FairyGUI.UIConfig
...
FontManager = CS.FairyGUI.FontManager
...
DragDropGoManager = CS.FairyGUI.DragDropGoManager
AutoSizeType = CS.FairyGUI.AutoSizeType
AlignType = CS.FairyGUI.AlignType
VertAlignType = CS.FairyGUI.VertAlignType
ProgressTitleType = CS.FairyGUI.ProgressTitleType
FlipType = CS.FairyGUI.FlipType
